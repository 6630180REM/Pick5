...
messaging.onBackgroundMessage(function(payload) {
  ...
  // Only process data payload
  if (!payload.data) {
    console.log('No data payload found, ignoring message.');
    return;
  }
...
self.addEventListener('notificationclick', function(event) {
  ...
  const urlToOpen = event.notification.data?.url || "https://6630180rem.github.io/Pick5/";
